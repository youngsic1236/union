  ...
  return (
    <main style={{ paddingTop: 68, backgroundColor: "#fff", minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 32px" }}>
        ...
        {/* Hero 이미지 + 소개 */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, marginBottom: 60, alignItems: "center" }}>
          <div style={{ position: "relative", aspectRatio: "3/4", overflow: "hidden", backgroundColor: "#f0f0f0" }}>
            <Image src="/images/events/petfesta_2.jpg" alt="유니온 그룹" fill style={{ objectFit: "cover" }} sizes="40vw" />
          </div>
          <div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32, marginBottom: 60 }}>
          {[
            ...
            { n: "02", t: "행사 내용 분석", d: "행사 기기 및 브랜드 분석\n행사 장소에따른 행사 대상 분석" },
            { n: "03", t: "미팅", d: "클라주주와 온현대서 실무적 미팅\n건격 제안 및 검토" },
            { n: "04", t: "1차 LIST UP", d: "기업 및 브랜드의 이미지에 어울리는 프로모터 1차 자체 선별 후 프로필 제출" },
            { n: "05", t: "2차 LIST UP", d: "클라주주와 통한 최종 인원 선별\n브랜드 및 기업 교육자료 전달" },
            { n: "06", t: "최종 선발", d: "인원들을 통한 최초 인원 선발\n브랜드 및 기업 교육자료 전달" },
            { n: "07", t: "일정 진행", d: "현장 기상에따라 탄력근무제 관리\n현장 담장자와 수시 소통" },
            { n: "08", t: "결과 보고", d: "행사 종료 후 클라장 감관에 피드백\n및 성영 결과 보고" },
          ].map((p) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 40, textAlign: "center" }}>
          {[
            { t: "프로모터", d: "각 브랜드과 기업의 이미지와 분위기에 어울리는 인원 선별\n자체분보, 분석을 통제한 인원들을 선별\n기본 경력 5년 - 10년 이상의 다 경험자 투입\n모델, 배우 쪽의 비주얼이 뛰어난 프로모터 선발\n행사 프로그램의 아이더가 뛰어난 인원도 선별" },
            { t: "슈퍼바이저", d: "기본 경력 5년 - 10년 이상의 전문 슈퍼바이저 투입\n행사전 전반적인 인원, 인력, 물자 공간 동의 뛰어난 선발\n플랩디이언트스 및 프로필사 참무와 소통이 가능하여 인원 신뢰\n현장 상황에 맞게 솔루션이 가능한 인재 선발" },
            { t: "스태프", d: "행사인의 특적과 맞지 않는 무 경험사 없음\n3000명 이상의 자체 DB풀을 통하여 무더입이 가능한 인원 선발\n기본경력 3년이상의 전문 운영 스태프 투입" },
          ].map((c) => (
            <div key={c.t}>
