    ...
    <footer style={{ backgroundColor: "#fff", borderTop: "1px solid #eee", padding: "32px 32px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 12 }}>
          <Image src="/images/logo/union-logo.png" alt="UNION GROUP" width={20} height={20} style={{ objectFit: "contain", filter: "invert(1)" }} />
        ...
        <p style={{ fontSize: 10, color: "#ccc", marginTop: 12 }}>© 2024 UNION GROUP. All rights reserved.</p>
      </div>
    </footer>
  );
}
