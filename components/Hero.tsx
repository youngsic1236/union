...
export default function Hero() {
  return (
    <main style={{ paddingTop: 68, backgroundColor: "#fff" }}>
      ...
      <div style={{ textAlign: "center", padding: "72px 32px 48px", borderBottom: "1px solid #eee" }}>
        ...
        <p style={{ fontSize: 13, color: "#555", lineHeight: 2, marginBottom: 28 }}>
          바이브 에이전시는 하나의 행사 1:1 맞춤 상담과 컨셉회의,<br />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <div>
            ...
            <ul style={{ listStyle: "none", lineHeight: 2.2, color: "#555", fontSize: 13 }}>
              ...
              <li style={{ marginTop: 8 }}>배우, 모델, 인플루언서 실내</li>
            </ul>
          </div>
          <div style={{ position: "relative", aspectRatio: "3/4", overflow: "hidden", backgroundColor: "#f5f5f5" }}>
            <Image src="/images/events/petfesta_3.jpg" alt="" fill style={{ objectFit: "cover" }} sizes="40vw" />
          </div>
        </div>
      </div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32 }}>
            {[
              ...
              { n: "03", t: "자체 교육 진행", d: "바이브에이전시 자체적으로 모집하여 교육 및 CS교육을 이수한 인원만 배치" },
